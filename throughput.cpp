...
void ThroughPut::paintGL()
{
   ...
   // Draw_line();
    ...
    if(bit_cnt_2_3 == 19500 ){
        sprintf(db_2,"Thtoughput : %lf  bps/Hz",4*(1-err_3/20000.0));
    }
    renderText(-0.2,-0.3,1,db_2);
}
