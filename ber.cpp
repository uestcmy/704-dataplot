...
void BER::resizeGL(int w, int h)
{
    ...
    */
    ...
    glOrtho (-1.2 * ( GLfloat ) w / ( GLfloat ) h, 2.3* ( GLfloat ) w / ( GLfloat ) h, -2, 2, -10.0, 15.0);
     //glFrustum (-1.5 * ( GLfloat ) w / ( GLfloat ) h, 2* ( GLfloat ) w / ( GLfloat ) h, 0.5, 1.5, 4, 10.0);
...
*/
    //histoPlot11();histoPlot12();histoPlot13();histoPlot14(); //orange
   // histoPlot21();histoPlot22();histoPlot23();histoPlot24(); //red
   // histoPlot31();histoPlot32();histoPlot33();histoPlot34(); //brown
   // histoPlot41();histoPlot42();histoPlot43();histoPlot44(); //yellow
...
void BER::keyPressEvent(QKeyEvent *event)
{
    switch (event->key())
    {
    case Qt::Key_Up :
...
void BER::timerEvent(QTimerEvent *event){
    glBegin(GL_QUADS);
